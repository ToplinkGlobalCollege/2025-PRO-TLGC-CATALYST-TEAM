# Introduction 
**control**- This folder contains the scripts to control motors, and sensors on the EV3. Enables basic to advanced movement like line following or turning.
...
**hardware**- This folder contains the EV3-specific hardware files, such as chassis designs, part configurations, or custom 3D-printed attachments.
